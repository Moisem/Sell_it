        ...
        <div class="col-sm-12 col-md-6 registro-main">
            <div class="guardar-izquierda">
                ...
                <div class="body-guardar">
                    <form id="formproducto" method="POST" action="{{route('producto.save')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="precio-guardar">
                            ...
                            <input id="precio" type="text" name="precio" class="form-control" required autocomplete="precio">
                            <span id="error2"></span>
                            @error('precio')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                        ...
                        <div class="noexistencia-register">
                            ...
                            <input id="noexistencia" type="text" name="noexistencia" class="form-control" required autocomplete="noexistencia">
                            <span id="error6"></span>
                            @error('noexistencia')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                        ...
                        <div class="descripcion-guardar">
                            ...
                            <textarea id="descripcion" type="textarea" name="descripcion" class="form-control" required autocomplete="descripcion"></textarea>
                            <span id="error7"></span>
                            @error('descripcion')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                        ...
                        <div class="btn-guardar mt-4">
                            <button id="btnEnviar" type="submit" class="btn btn-warning btn-guardar">
                                {{ __('Guardar') }}
                            </button>
                        </div>
                    </form>
